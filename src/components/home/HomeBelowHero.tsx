...
export function HomeBelowHero() {
  return <div className="aero-home-lower overflow-hidden">
    ...
    <section data-luxury-section="campaign" className="aero-carousel-section bg-ivory py-20 md:py-28"><Container><Reveal><p className="eyebrow text-center">03 / New collection</p><h2 className="aero-carousel__heading">NEW COLLECTION</h2></Reveal><CollectionCarousel /><Reveal delay={80}><div className="mt-10 flex justify-center"><Link href="/products" className="aero-carousel__view-all">VIEW ALL</Link></div></Reveal></Container></section>

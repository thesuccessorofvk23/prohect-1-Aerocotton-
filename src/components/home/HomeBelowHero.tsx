...
const catalogueRows = [
  ...
  { collection: collections[3], title: "Terry towel sets", meta: "Towels", year: "Built to brief", image: "/images/editorial/workshop-detail.jpg", alt: "City collection terry towel in the workshop", layout: "narrow" },
